...
> time. This pass targets everything [UI Spec](https://github.com/cheyras/deckpal/wiki/UI-Spec) marked **U** (undetermined): interaction states,
...
**Conclusion: [UI Spec](https://github.com/cheyras/deckpal/wiki/UI-Spec) §3.13's modal/sheet spec stays an `I` proposal. There is nothing to
...
6. **Modal / dialog / bottom sheet.** Confirmed *not to exist* anywhere reachable signed out —
   so [UI Spec](https://github.com/cheyras/deckpal/wiki/UI-Spec) §3.13 remains our invention, now with the knowledge that we are inventing rather
