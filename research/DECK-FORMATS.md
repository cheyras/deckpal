...
> handful of lines as evidence of that format — the same posture [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) takes toward
...
carry a `tcgplayer_abbrev` column too (obtainable from TCGCSV's group data, which [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §7
...
⇒ **This is exactly what `playable_fingerprint` ([Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §3 item 4) computes.** Implement
...
| J7 | **Card marks / legality cross-check** | TCGdex GraphQL, one query per set | JSON | rides the existing catalogue sync ([Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §3 item 8) | store `regulationMark`; diff `legal.standard` vs our computed value and log divergences | — |
...
**Why the fingerprint matters here too:** [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §3 item 4 is right that
...
Postgres. Naming follows [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art)'s guidance (real Alembic migrations, keep the FKs, no
...
Assumes the card/variant model from `BEHAVIOR-SPEC.md` §1 and [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §1. Additions:
...
[Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §5(b): joining a decklist to the owned collection is *"the single largest genuine
...
4. `playable_fingerprint` (port from pokecollector, AGPL-aware — [Prior Art](https://github.com/cheyras/deckpal/wiki/Prior-Art) §3 item 4) and
