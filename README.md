...
**Why this shape:** it mirrors the existing `/home/cheyras/the-original-host-api/` pnpm workspace
...
Prereqs (already true on the original host): Node 20, pnpm 10, host Postgres 17.9, passwordless
`sudo -u postgres`.
