...
export function ValueChart({
  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      ...
      {active && (
        <div
          className="pointer-events-none absolute z-(--z-popover) -translate-x-1/2 rounded-lg border border-border-default bg-surface-secondary px-[10px] py-[6px] text-[12px] shadow-panel"
          style={{
            left: `${(x(hover!) / W) * 100}%`,
            top: 8,
          }}
