...
test('speciesSprite — pure function of dex id, pixel + art + shiny paths', () => {
  ...
  assert.equal(s.pixel, '/pokedex/images/sprites/pixel/6.png');
  assert.equal(s.pixelShiny, '/pokedex/images/sprites/pixel/shiny/6.png');
  assert.equal(s.art, '/pokedex/images/sprites/art/6.png');
  assert.equal(s.artShiny, '/pokedex/images/sprites/art/shiny/6.png');
});
