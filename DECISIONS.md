...
What it traces that line-snap could not, in `~/.legacy-dev-hub-legacy/foil-shots/mask-edgetrace/`:
...
`~/.legacy-dev-hub-legacy/foil-shots/mask-edgetrace/`, with the numbers on `00-summary.png`.
