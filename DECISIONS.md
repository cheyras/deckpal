...
5. Remote HTTPS (cheyrasnet.tplinkdns.com/pokedex/) works via Authelia; git history has one entangled commit (e0e5fd4) from the concurrent Phase 7/8 agents — cosmetic, nothing lost.
