...
- Wave boundaries are checkpoints: write a short retro to OpenBrain (what shipped, what the next
...
| 5184–5189 | spares — allocate here and record in this table |
...
Prod (`http://the.grid/pokedex/`) is pre-registered in the hub menu as a permanent entry.
