/**
 * Vercel serverless function — the cloud image tier for `/deckscout/images/*`.
 *
 * vercel.json rewrites `/deckscout/images/(.*)` here (ahead of the SPA catch-all,
 ...
 * local WebP cache. Both tiers share the path algebra in `@deckscout/storage`.
 *
