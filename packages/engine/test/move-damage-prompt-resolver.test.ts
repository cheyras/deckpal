...
import { State, Player, ResolvePromptAction, GameMessage, PokemonSlot,
  MoveDamagePrompt, PlayerType, SlotType, PokemonCard, DamageMap, DamageTransfer} from '../src/common';
import { MoveDamagePromptResolver } from '../src/bot/prompt-resolver/move-damage-prompt-resolver';
import {
  allSimpleTactics,
  allPromptResolvers,
  defaultStateScores,
