...
import { State, Player, ResolvePromptAction, GameMessage, ChooseAttackPrompt,
  PokemonCard, CardType, Attack, PowerType, Power } from '../src/common';
import { ChooseAttackPromptResolver } from '../src/bot/prompt-resolver/choose-attack-prompt-resolver';
import {
  allSimpleTactics,
  allPromptResolvers,
  defaultStateScores,
