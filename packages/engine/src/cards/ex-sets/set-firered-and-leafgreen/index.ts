...
import { Bulbasaur2 } from './bulbasaur-2';
...
import { Charmander3 } from './charmander-3';
import { Charmeleon } from './charmeleon';
import { ClefableEx } from './clefable-ex';
...
import { MoltresEx } from './moltres-ex';
import { MrMimeEx } from './mr-mime-ex';
import { MrMimeEx2 } from './mr-mime-ex-2';
...
import { ProfOaksResearch } from './prof-oaks-research';
...
export const setFireredAndLeafgreen: Card[] = [
  new Arcanine(),
  new ArticunoEx(),
  new Beedrill(),
  new Bellsprout(),
