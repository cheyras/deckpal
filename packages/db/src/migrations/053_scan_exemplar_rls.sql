-- @supabase-only
-- 053 · Row-Level Security for the verify flywheel (052).
--
...
--
-- Depends on: 052_scan_exemplar, 020_multi_user_uuid.
--
-- ══════════════════════════════════════════════════════════════════════════════
...
--   052's withdrawal trigger is what stops from being forgotten.
--
...
-- The catalogue's own embeddings (051) are public reference data, exactly like
