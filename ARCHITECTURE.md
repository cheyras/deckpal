...
DeckScout is a single-user Pokémon TCG collection app that runs entirely on the original host
...
| `deckscout-dev-hub-legacy` | 3999 | Dev-surface menu (LAN-only) | `tools/dev-hub-legacy/`; not production traffic |
